...
//        {
//            curState = startState;
//            GetLength = curState == State.Up ? lengthRange.y : lengthRange.x;
//        }

//        private void Update()
//        {
//            GetLength += curSpeed * Time.deltaTime;
...
//                GetLength = Mathf.Lerp(GetLength, targetLength, 7.5f * Time.deltaTime);
//            }
//            else
//            {
//                if (curState == State.Up)
